...
const {uploadMiddleware, uploadImageMiddleware} = require("../../utils/multer");
...
router.post('/upload-image', uploadImageMiddleware('User-ar-experience').single('images'), uploadImageThroughQrScanningSpecificIndex);
...
router.delete('/remove-card/:id', userAuth, deleteUserCustomizeCard);
router.get('/get-all-express-shipping-users', adminAuth, getAllExpressShippingUsers);
// router.post('/update-image', uploadImageMiddleware('User-ar-experience').single('images'), updateImageThroughQrScanningSpecificIndex);
